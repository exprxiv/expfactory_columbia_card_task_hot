	...
	if (board_type == 2) {
		...
		for (i = 1; i < 33; i++) {
			board += "<div class = square><input type='image' id = " + i +
				" class = 'card_image' src='assets/images/beforeChosen.png' onclick = instructCard(this.id)></div>"
		}
		...
		for (i = 1; i < 33; i++) {
			board += "<div class = square><input type='image' id = " + i +
				" class = 'card_image select-button' src='assets/images/beforeChosen.png' onclick = chooseCard(this.id)></div>"
		}
	}
	board += "</div>"
	return board
...
var getRound = function() {
	...
	if (roundOver === 0) { //this is for the start of a round
		...
		for (i = 0; i < clickedGainCards.length; i++) {
			gameState = appendTextAfter2(gameState, "id = " + "" + clickedGainCards[i] + ""," class = 'card_image' src='assets/images/chosen.png'", " class = 'card_image select-button' src='assets/images/beforeChosen.png' onclick = chooseCard(this.id)")
		}
		return gameState
		...
		for (var i = 1; i < cardArray.length + 1; i++) {
			if (clickedGainCards.indexOf(i) != -1 ) {
				gameState = appendTextAfter2(gameState, "id = " + "" + i + ""," class = 'card_image' src='assets/images/chosen.png'", " class = 'card_image select-button' src='assets/images/beforeChosen.png' onclick = chooseCard(this.id)")
			} else if (clickedLossCards.indexOf(i) != -1 ) {
				gameState = appendTextAfter2(gameState, "id = " + "" + i + ""," class = 'card_image' src='assets/images/loss.png'", " class = 'card_image select-button' src='assets/images/beforeChosen.png' onclick = chooseCard(this.id)")
			} else {
				gameState = appendTextAfter2(gameState, "id = " + "" + i + ""," class = 'card_image' src='assets/images/beforeChosen.png'", " class = 'card_image select-button' src='assets/images/beforeChosen.png' onclick = chooseCard(this.id)")
			}
		}
...
var instructFunction2 = function() {
	...
	var instructTurnCards = function() {
		document.getElementById("8").src = 'assets/images/loss.png';
		document.getElementById("2").src = 'assets/images/loss.png';
...
var instructions_block = {
  ...
  pages: [
    ...
    "<p><input type='image' id = '133' src='assets/images/beforeChosen.png' onclick = instructButton(this.id)>"+
	'</p></div>',
	...
	"<p><input type='image' src='assets/images/chosen.png'>"+
	'<p><strong>The Loss Card:</strong></p>'+
	"<p><input type='image' src='assets/images/loss.png'></p>"+
